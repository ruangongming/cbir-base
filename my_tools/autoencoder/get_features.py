...
def generate_features_autoencoder(train):
    ...
    # Generating the respective feature of images_y in latent vector spaces
...
if __name__ == '__main__':
    ...
    print("There are {} training images_y and {} images_y for validation".format(len(train_ds), len(val_ds)))
